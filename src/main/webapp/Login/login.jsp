...
<main class="auth-wrapper">
    <div class="auth-card">
        ...
        <div class="auth-card-body">
            ...
            <%-- Thông báo đăng ký thành công từ session --%>
            <%
            ...
            %>
            <% if (regSuccess != null) { %>
            <div class="server-success" style="color:#155724;background:#d4edda;border:1px solid #c3e6cb;padding:10px 14px;border-radius:4px;margin-bottom:12px;font-size:14px;display:flex;align-items:center;gap:8px;">
